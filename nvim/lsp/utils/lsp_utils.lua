-- Shamelessly stolen from https://github.com/neovim/nvim-lspconfig/blob/master/lua/lspconfig/util.lua
-- With only a few modifications. Why don't I just use lspconfig you say? Great question.
