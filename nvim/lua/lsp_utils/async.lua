-- Another file shamelessly stolen from lspconfig.
-- This is only used in rust-analyzer.
-- TODO: Remove if/when I write a custom rust language server configuration.
local M = {}
